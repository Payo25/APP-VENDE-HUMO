...
app.post('/api/invoices/:id/send-email', async (req, res) => {
  ...
  try {
    ...
    <div style="max-width:700px;margin:0 auto;font-family:Arial,sans-serif;color:#333">
      ...
      <p style="text-align:center;color:#999;font-size:11px">This invoice was generated by Proassisting Inc. — info@proassisting.net</p>
    </div>`;

    const emailFrom = process.env.NOTIFICATION_EMAIL_FROM || 'info@proassisting.net';
    if (!process.env.SENDGRID_API_KEY) {
